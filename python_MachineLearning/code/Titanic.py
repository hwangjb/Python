...
print('data set Null Count :', titanic_df.isnull().sum().sum())
...
def exec_kfold(clf, folds=5):
    ...
    for iter_count, (train_index, test_index) in enumerate(kfold.split(x_titanic_df)):
        ...
        y_train, y_test = y_titanic_df.values[train_index], y_titanic_df[test_index]
...
print('GridSearchCB 최적 정확도 : {0:.4f}'.format(grid_dclf.best_score_))
